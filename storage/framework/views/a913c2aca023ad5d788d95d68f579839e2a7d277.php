          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <a data-toggle = "modal" href = "" data-target = "#add_user" class="btn btn-sm btn-primary">Add User</a>
                </div>
              </div>
                        ...
                        <tr>
                          ...
                          <td class="td-actions text-right">
                            <form method="post" action="<?php echo e(route('user.destroy', $user->id)); ?>">
                              <a rel="tooltip" class="btn btn-success btn-link" href="<?php echo e(route('user.edit', $user->id)); ?>" data-original-title="" title="">
                                <i class="material-icons">edit</i>
                              </a>
                              <?php echo csrf_field(); ?>
                              <?php echo method_field('DELETE'); ?>
                              <a rel="tooltip" data-original-title="" title="" class="btn btn-success btn-link" class="btn btn-danger btn-fab btn-fab-mini btn-round"  onclick="confirm('<?php echo e(__('Are you sure you want to delete this customer?')); ?>') ? this.parentElement.submit() : ''">
...
<?php echo $__env->make('layouts.app', ['activePage' => 'User-Management', 'titlePage' => __('User List')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\working_folder\real_project\malaysia_project\wordpress_admin2\wordpress_admin\resources\views/users/index.blade.php ENDPATH**/ ?>