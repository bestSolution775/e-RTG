        ...
        <div class="card">
          ...
          <div class="col-12">
            <form method="post" action="<?php echo e(route('customers.search')); ?>">
              ...
              <button type="submit" class="btn btn-orange btn-round btn-just-icon">
                ...
                <tbody>
                  <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      ...
                      <td><?php echo e($customer->dbname); ?></td>
                      <td>
...
<?php echo $__env->make('layouts.app', ['activePage' => 'Customer-Management', 'titlePage' => __('Customer List')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\working_folder\crt_project\resources\views/customers/index.blade.php ENDPATH**/ ?>