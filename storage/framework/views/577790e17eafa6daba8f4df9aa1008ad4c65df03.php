                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a class="btn btn-info btn-fab btn-fab-mini btn-round">
                          <i class="material-icons" onclick = "edit(<?php echo e($country); ?>);" style="color:white">edit</i>
                        </a> 
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('DELETE'); ?>
                        <a class="btn btn-danger btn-fab btn-fab-mini btn-round"  onclick="confirm('<?php echo e(__('Are you sure you want to delete this user?')); ?>') ? this.parentElement.submit() : ''" style="color:white">
      ...
      <form method="post" action="<?php echo e(route('countries.store')); ?>">
        ...
        <div class="modal-body">
            <div class="w-50 mx-auto">
              ...
              <br>
              <div class="input-group">
                <input name="country_code" type="number" class="form-control" placeholder="Input country code" require>
              </div>
            </div>
      ...
      <form method="post" action="<?php echo e(route('countries.store')); ?>">
        ...
        <div class="modal-body">
            <div class="w-50 mx-auto">
              ...
              <br>
              <div class="input-group">
                <input name="country_code" id = "country_code" type="number" class="form-control" require>
              </div>
            </div>
...
<?php echo $__env->make('layouts.app', ['activePage' => 'Country-Management', 'titlePage' => __('Table List')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\working_folder\malaysia_project\myproject\resources\views/country/index.blade.php ENDPATH**/ ?>