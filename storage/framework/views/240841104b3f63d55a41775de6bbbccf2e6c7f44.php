                              ...
                              <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <li style="cursor:pointer;">
                                      ...
                                      <i class="material-icons category_edit" onclick = "category_edit(<?php echo e($category); ?>);">edit</i>
                                        <i class="material-icons category_delete" onclick="confirm('<?php echo e(__('Are you sure you want to delete this distributor?')); ?>') ? remove_category(<?php echo e($category->id); ?>) : ''">delete</i>
...
<?php echo $__env->make('layouts.app', ['activePage' => 'Category-Management', 'titlePage' => __('Category List')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\working_folder\real_project\malaysia_project\wordpress_admin2\wordpress_admin\resources\views//products/categories/index.blade.php ENDPATH**/ ?>