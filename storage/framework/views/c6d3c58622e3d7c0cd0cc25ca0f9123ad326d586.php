...
<?php $__currentLoopData = $childs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			<li style="cursor:pointer;">
				...
				<i class="material-icons category_delete" onclick="confirm('<?php echo e(__('Are you sure you want to delete this distributor?')); ?>') ? remove_category(<?php echo e($child->id); ?>) : ''">delete</i>
...
</ul><?php /**PATH E:\working_folder\real_project\malaysia_project\wordpress_admin2\wordpress_admin\resources\views/products/categories/manageChild.blade.php ENDPATH**/ ?>