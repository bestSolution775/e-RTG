    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="col-12">
            <form method="post" action="<?php echo e(route('distributors.search')); ?>">
              <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', ['activePage' => 'Distributor-Management', 'titlePage' => __('Distributor List')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\working_folder\crt_project\resources\views/distributors/searchResult.blade.php ENDPATH**/ ?>